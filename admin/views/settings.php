...
<div class="wrap wp-staff-diary-wrap">
    ...
    <div id="fitters-tab" class="settings-tab" style="display:none;">
        ...
        <div id="fitters-management" class="wp-staff-diary-management-section">
            ...
            <!-- Fitter Availability / Holidays Section -->
            <div style="margin-top: 40px; padding-top: 30px; border-top: 2px solid #ddd;">
                <h2>Fitter Availability & Holidays</h2>
                <p>Track when fitters are unavailable due to holidays, sick leave, or other reasons. This will help prevent double-booking.</p>
                ...
                $availability_records = $wpdb->get_results(
                    "SELECT * FROM $table_availability ORDER BY start_date DESC LIMIT 50"
                );
                ?>

                <table class="wp-list-table widefat fixed striped" id="fitter-availability-table" style="margin-top: 20px;">
                    <thead>
                        <tr>
                        ...
                        <?php if (empty($availability_records)): ?>
                            <tr>
                                <td colspan="6" style="text-align: center; color: #666; padding: 30px;">
                                    No availability records yet. Add your first entry below.
                                </td>
                            </tr>
                        <?php else: ?>
                ...
                <div class="add-availability-form" style="margin-top: 20px; padding: 20px; background: #f9f9f9; border-radius: 4px;">
                    <h3>Add Unavailable Period</h3>
                    <table class="form-table">
                        <tr>
                            <th><label for="new-availability-fitter">Fitter <span class="required">*</span></label></th>
                            <td>
                        ...
                        <tr>
                            <th><label for="new-availability-start">Start Date <span class="required">*</span></label></th>
                            <td><input type="date" id="new-availability-start" class="regular-text" required></td>
                        </tr>
                        <tr>
                            <th><label for="new-availability-end">End Date <span class="required">*</span></label></th>
                            <td><input type="date" id="new-availability-end" class="regular-text" required></td>
                        </tr>
                        <tr>
                            <th><label for="new-availability-type">Type <span class="required">*</span></label></th>
                            <td>
                    ...
                    <button type="button" id="add-availability-btn" class="button button-primary">
